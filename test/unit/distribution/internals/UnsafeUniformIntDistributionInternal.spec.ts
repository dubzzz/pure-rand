...
} from '../../../../src/distribution/internals/UnsafeUniformIntDistributionInternal';
...
describe.each([{ withBigInt: true }, { withBigInt: false }])(
  'unsafeUniformIntDistributionInternal (bigint: $withBigInt)',
  ({ withBigInt }) => {
    const unsafeUniformIntDistributionInternal = withBigInt
      ? unsafeUniformIntDistributionInternalBigInt
      : unsafeUniformIntDistributionInternalNoBigInt;
