...
import { xoroshiro128plusBigInt, xoroshiro128plusNoBigInt } from '../../../src/generator/XoroShiro';
import * as p from './RandomGenerator.properties';

describe.each([{ withBigInt: true }, { withBigInt: false }])(
  'xoroshiro128plus (bigint: $withBigInt)',
  ({ withBigInt }) => {
    const xoroshiro128plus = withBigInt ? xoroshiro128plusBigInt : xoroshiro128plusNoBigInt;
    ...
    it('Should return the same sequence if called twice', () =>
      fc.assert(p.sameSequencesIfCallTwice(xoroshiro128plus)));
